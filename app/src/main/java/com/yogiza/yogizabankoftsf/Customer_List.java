...
public class Customer_List extends AppCompatActivity {
    ...
    private void showData() {
        ...
        adapter = new CustomeAdapter_userlist(Customer_List.this, modelList_showlist);
    ...
    public void nextActivity(int position) {
        ...
        Intent intent = new Intent(Customer_List.this, Personal_Data.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.action_history){
            startActivity(new Intent(Customer_List.this, Trans_History.class));
        }
