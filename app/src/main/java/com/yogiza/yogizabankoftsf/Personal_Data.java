...
public class Personal_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Personal_Data.this);
    ...
    private void showData(String phonenumber) {
        Cursor cursor = new DBHelper(this).readparticulardata(phonenumber);
    ...
    private void enterAmount() {
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(Personal_Data.this);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mAmount.getText().toString().isEmpty()){
                    ...
                    Intent intent = new Intent(Personal_Data.this, Send_To_User.class);
    ...
    private void transactionCancel() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(Personal_Data.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new DBHelper(Personal_Data.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
                        Toast.makeText(Personal_Data.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                    }
